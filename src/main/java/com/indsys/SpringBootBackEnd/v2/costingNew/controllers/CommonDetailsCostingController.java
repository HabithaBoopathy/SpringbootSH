...
public class CommonDetailsCostingController {
    ...
    @PostMapping("/sampleHead1")
    public List<CommonDetailsCosting> getAllForSampleHead1(@RequestBody String[] trimTypes){
        return commonDetailsCostingRepository.getForSampleHead(trimTypes);
    }
    @PostMapping("/sampleHead2")
    public List<CommonDetailsCosting> getAllForSampleHead2(@RequestBody String[] trimTypes) {
        return commonDetailsCostingRepository.getForSampleHead(trimTypes);
    }
